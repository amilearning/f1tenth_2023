...
class Collector(Node):
    ...
    def calibrate_straight(self):
        '''
        calibrate a servo so it goes to straight with zero command 
        '''        
        self.cmd_msg.drive.steering_angle = float(self.target_delta)        
        self.straight_vel = 1.0
        self.cmd_msg.drive.speed = float(self.straight_vel)


        self.cmd_msg.drive.steering_angle_velocity = 0.0
        self.cmd_msg.drive.acceleration = 0.0
        self.cmd_msg.drive.jerk = 0.0
